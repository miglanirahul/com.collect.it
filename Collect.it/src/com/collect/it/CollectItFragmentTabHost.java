...
public class CollectItFragmentTabHost extends TabHost implements
	...
	static class CollectitTabFactory implements TabHost.TabContentFactory {
		private final Context mContext;

		public CollectitTabFactory(Context context) {
			mContext = context;
		}
	...
	public CollectItFragmentTabHost(Context context) {
	...
	public CollectItFragmentTabHost(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void addTab(TabHost.TabSpec tabSpec, Class<?> clss, Bundle args) {
		tabSpec.setContent(new CollectitTabFactory(mContext));
