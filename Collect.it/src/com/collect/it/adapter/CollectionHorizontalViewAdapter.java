...
/**
 * This adapter class used to display the gallery view for the collections on
 * add item screen
 */
public class CollectionHorizontalViewAdapter extends BaseAdapter {
	 ...
	 */
	public CollectionHorizontalViewAdapter(Activity context,
	...
	public int getCount() {
		if (CollectItSharedDataModel.getInstance()
			...
			return CollectItSharedDataModel.getInstance()
					.getCollectionGalleryArrayList().size();
		} else {
			return 0;
		}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			if (CollectItSharedDataModel.getInstance()
					.getCollectionGalleryArrayList().size() > position) {
				holder.textView.setText(CollectItSharedDataModel.getInstance()
						.getCollectionGalleryArrayList().get(position)
						.getCollectionTitle());
