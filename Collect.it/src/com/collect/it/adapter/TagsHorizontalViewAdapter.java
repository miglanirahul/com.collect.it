...
/**
 * This class is used to display the gallery for the tags on Add item screen
 */
public class TagsHorizontalViewAdapter extends BaseAdapter {
	 ...
	 */
	public TagsHorizontalViewAdapter(Activity context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			if (CollectItSharedDataModel.getInstance().getTagGalleryArrayList()
					.size() > position) {
				holder.textView.setText(CollectItSharedDataModel.getInstance()
						.getTagGalleryArrayList().get(position).getTagTitle());
				holder.textView.setBackgroundResource(CollectItSharedDataModel
						.getInstance().getTagGalleryArrayList().get(position)
